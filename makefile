...
HOSTNAME != hostname -s
# PARAMS ?=
TARGETS = terminal pf syslog user dns certificate database httpd dovecot spamd redis rspamd smtpd
CONTROLLER = terminal pf syslog user dns certificate database httpd redis smtpd
