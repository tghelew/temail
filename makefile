...
CONTROLLER = terminal pf user dns certificate database httpd redis smtpd relayd sogo syslog
MAIL = terminal pf  user dns database httpd dovecot spamd redis rspamd smtpd syslog
