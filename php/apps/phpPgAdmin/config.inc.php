<?php
	...
	$conf['servers'][1]['desc'] = 'Standby - Eshub';
	$conf['servers'][1]['host'] = 'eshub.ghelew.ch';
	$conf['servers'][1]['port'] = 5432;
	$conf['servers'][1]['pg_dump_path'] = '/usr/local/bin/pg_dump';
	$conf['servers'][1]['pg_dumpall_path'] = '/usr/local/bin/pg_dumpall';
	$conf['servers'][1]['sslmode'] = 'disable';

	$conf['servers'][2]['desc'] = 'Standby - Eshuc';
	$conf['servers'][2]['host'] = 'eshuc.ghelew.ch';
	$conf['servers'][2]['port'] = 5432;
	$conf['servers'][2]['pg_dump_path'] = '/usr/local/bin/pg_dump';
	$conf['servers'][2]['pg_dumpall_path'] = '/usr/local/bin/pg_dumpall';
